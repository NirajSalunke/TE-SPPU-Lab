...
public class Main {
    public static void main(String[] args) {
        MongoClientURI uri = new MongoClientURI("mongodb://te31463:te31463@10.10.8.55/");
//        MongoClientURI uri1 = new MongoClientURI("mongodb://localhost:27017/");
        MongoClient client = new MongoClient(uri);
        System.out.println("Connected to DB");
        MongoDatabase db = client.getDatabase("te31463_db");
